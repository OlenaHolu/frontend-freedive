...
const SummaryStatsPanel = ({ totalDive, totalSurface, t }) => {
    ...
    return (
        <div title={t("stats.timeSpentUnderwater")} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-blue-100 p-4 rounded-lg shadow text-center">
                <div className="text-sm text-gray-500">{t("stats.underwater")}</div>
            ...
            <div title={t("stats.surfaceRecoveryTime")} className="bg-orange-100 p-4 rounded-lg shadow text-center">
                <div className="text-sm text-gray-500">{t("stats.surface")}</div>
                <div className="text-xl font-semibold">
            ...
            <div title={t("stats.recoveryRatioExplanation")} className="bg-green-100 p-4 rounded-lg shadow text-center">
                <div className="text-sm text-gray-500">{t("stats.recoveryRatio")}</div>
                <div className="text-xl font-semibold">{ratio} : 1</div>
            </div>
        </div>
    );
};
